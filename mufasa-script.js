document.addEventListener('DOMContentLoaded', function() {
    // Movie video URLs in different languages - SPECIFICALLY FOR MUFASA
    const movieVideos = {
        "de": "https://voe.sx/e/2bnuxpczhmja", // German version of Mufasa
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL for Mufasa
    const trailerUrl = "https://www.youtube.com/embed/hy9e-2JvQXk"; // Mufasa trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Mufasa: The King of Tigers (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Mufasa: The King of Tigers - Official Trailer';
    ...
    // Set the movie backdrop image
    document.querySelector('.movie-backdrop').style.backgroundImage = "url('https://wallpapercave.com/wp/wp12819471.jpg')";
});