document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/4d27cyjtb1tu", // German version of Hitman: Agent 47
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/alQlJDRnQkE"; // Hitman: Agent 47 official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Hitman: Agent 47 (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Hitman: Agent 47 - Official Trailer';
