document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/9h0bt2sap2vq", // Corrected German version of Oppenheimer
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/uYPbbksJxIg"; // Oppenheimer official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Oppenheimer (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Oppenheimer - Official Trailer';
