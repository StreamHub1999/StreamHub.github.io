document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/icpnciuutkwx", // German version of Deadpool 2
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/20bpjtCbCz0"; // Deadpool 2 official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Deadpool 2 (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Deadpool 2 - Official Trailer';
