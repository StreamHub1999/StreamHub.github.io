document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/qu58ep65crtf", // German version of Deadpool
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/ONHBaC-pfsk"; // Deadpool official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Deadpool (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Deadpool - Official Trailer';
