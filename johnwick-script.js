document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/x8ftf5x49xbu", // German version of John Wick
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/2AUmvWm5ZDQ"; // John Wick official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `John Wick (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'John Wick - Official Trailer';
