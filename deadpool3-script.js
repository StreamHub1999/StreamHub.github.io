document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/ttb5idex6ofb", // German version of Deadpool & Wolverine
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/UMBd9CmVrqE"; // Deadpool & Wolverine official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Deadpool & Wolverine (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Deadpool & Wolverine - Official Trailer';
