document.addEventListener('DOMContentLoaded', function() {
    ...
    const movieVideos = {
        "de": "https://voe.sx/e/vmfdueeevzm5", // German version of Joker
        "en": "" // English version (placeholder for future)
    };
    
    // Trailer URL
    const trailerUrl = "https://www.youtube.com/embed/zAGVQLHvwOY"; // Joker official trailer
    ...
    function loadAndPlayMovie(language) {
        ...
        modalTitle.textContent = `Joker (${langText})`;
    ...
    document.querySelector('.trailer-btn').addEventListener('click', function() {
        ...
        modalTitle.textContent = 'Joker - Official Trailer';
